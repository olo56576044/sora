...
public class CryptoUtil {
	...
	// MD5 (message-digest algorithm)는 콘텐츠 검증 및 디지털 서명뿐만 아니라 메시지 인증에 사용되는 해시 알고리즘.
	 ...
	 * SHA 이름의 예로는 SHA-1, SHA-2, SHA-256, SHA-512, SHA-224, SHA-384
	 * 실제로는 SHA-1 및 SHA-2의 두 가지 유형이 이다. (SHA-3도 있음) 
	 */
